...
DISCLAIMER: This is the locally stored version of the "utm" library found within python's library
            ...
            The library contained this file (conversion.py) as well as error.py, there is a similar
            disclaimer that can be found there as we needed to store both files locally.
...
def from_latlon(latitude, longitude, force_zone_number=None, force_zone_letter=None):
    """This function convert Latitude and Longitude to UTM coordinate
        ...
        force_zone_letter: str
            Zone Letter is used with the Zone Number to represent a specific UTM
            Zone with the number.
            More information see utmzones [1]_
       .. _[1]: http://www.jaworski.ca/utmzones.htm
    """
